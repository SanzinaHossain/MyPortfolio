...
const DashBoard = () => {
  ...
  <div class="drawer-side lg:bg-secondary bg-green-500">
    ...
    <ul class="p-4 overflow-y-auto w-80  mt-5">
        ...
        <li class=" p-2 text-xl text-white mt-4  border-4 rounded-full border-primary text-center bg-primary hover:bg-orange-500 hover:border-orange-500"><Link to="/blogs">My Skills</Link></li>
